...
cwc.protocol.ev3.Commands.prototype.getBattery = function() {
  return new cwc.protocol.ev3.Buffer()
    .writeHeader(cwc.protocol.ev3.CallbackType.BATTERY, 0)
    .writeCommand(cwc.protocol.ev3.Command.UI.READ.BATTERY)
    .writeIndex()
    .readSigned();
};
...
cwc.protocol.ev3.Commands.prototype.getDeviceType = function(port) {
  return new cwc.protocol.ev3.Buffer()
    .writeHeader(cwc.protocol.ev3.CallbackType.DEVICE_NAME, 0x7F)
    .writeCommand(cwc.protocol.ev3.Command.INPUT.DEVICE.GETDEVICENAME)
    .writePort(port)
    .writeByte(0x7F)
    .writeIndex()
    .readSigned();
...
cwc.protocol.ev3.Commands.prototype.getFirmware = function() {
  return new cwc.protocol.ev3.Buffer()
    .writeHeader(cwc.protocol.ev3.CallbackType.FIRMWARE, 0x10)
    .writeCommand(cwc.protocol.ev3.Command.UI.READ.FIRMWARE)
    .writeByte(0x10)
    .writeIndex()
    .readSigned();
};
...
cwc.protocol.ev3.Commands.prototype.getActorData = function(port, mode = 0) {
  ...
  let buffer = new cwc.protocol.ev3.Buffer()
    .writeHeader(cwc.protocol.ev3.CallbackType.ACTOR_VALUE)
    .writeCommand(cwc.protocol.ev3.Command.INPUT.DEVICE.READRAW)
    .writePort(port)
    .writeNullByte()
    .writeByte(mode)
    .writeSingleByte()
...
cwc.protocol.ev3.Commands.prototype.getSensorData = function(port, mode = 0) {
  ...
  let buffer = new cwc.protocol.ev3.Buffer()
    .writeHeader(cwc.protocol.ev3.CallbackType.DEVICE_RAW_VALUE)
    .writeCommand(cwc.protocol.ev3.Command.INPUT.DEVICE.READRAW)
    .writePort(port)
    .writeNullByte()
    .writeByte(mode)
...
cwc.protocol.ev3.Commands.prototype.getSensorDataPct = function(port,
  ...
  let buffer = new cwc.protocol.ev3.Buffer()
    .writeHeader(cwc.protocol.ev3.CallbackType.DEVICE_PCT_VALUE)
    .writeCommand(cwc.protocol.ev3.Command.INPUT.DEVICE.READPCT)
    .writePort(port)
    .writeNullByte()
    .writeByte(mode)
    .writeSingleByte()
...
cwc.protocol.ev3.Commands.prototype.getSensorDataSi = function(port, mode = 0) {
  ...
  let buffer = new cwc.protocol.ev3.Buffer()
    .writeHeader(cwc.protocol.ev3.CallbackType.DEVICE_SI_VALUE)
    .writeCommand(cwc.protocol.ev3.Command.INPUT.DEVICE.READSI)
    .writePort(port)
    .writeNullByte()
    .writeByte(mode)
    .writeSingleByte()
...
cwc.protocol.ev3.Commands.prototype.setLed = function(color,
  ...
  return new cwc.protocol.ev3.Buffer()
    .writeHeader()
    .writeCommand(cwc.protocol.ev3.Command.UI.WRITE.LED)
 ...
 * @export
 */
cwc.protocol.ev3.Commands.prototype.movePower = function(ports, power, brake) {
  return new cwc.protocol.ev3.Buffer()
    .writeHeader()

    .writeCommand(cwc.protocol.ev3.Command.OUTPUT.STOP)
    .writePorts(ports)
    .writeByte(brake ? 1 : 0)

    .writeCommand(cwc.protocol.ev3.Command.OUTPUT.POWER)
    .writePorts(ports)
    .writeByte(power)

    .writeCommand(cwc.protocol.ev3.Command.OUTPUT.START)
    .writePorts(ports)
...
cwc.protocol.ev3.Commands.prototype.moveSteps = function(ports, steps,
  ...
  return new cwc.protocol.ev3.Buffer()
    ...
    .writeCommand(cwc.protocol.ev3.Command.OUTPUT.STEP.SPEED)
    .writePorts(ports)
...
cwc.protocol.ev3.Commands.prototype.clear = function() {
  return new cwc.protocol.ev3.Buffer()
    .writeHeader()
    .writeCommand(cwc.protocol.ev3.Command.INPUT.DEVICE.CLEARALL)
    .writeNullByte()
    .readSigned();
};
...
cwc.protocol.ev3.Commands.prototype.playTone = function(frequency, opt_duration,
  ...
  return new cwc.protocol.ev3.Buffer()
    .writeHeader()
    .writeCommand(cwc.protocol.ev3.Command.SOUND.TONE)
    .writeByte(Math.min(100, Math.max(0, opt_volume || 100)))
    .writeShort(frequency)
    .writeShort(Math.max(opt_duration || 50, 50))
    .readSigned();
};
 ...
 * @export
 */
cwc.protocol.ev3.Commands.prototype.playSound = function(file_name, volume) {
  return new cwc.protocol.ev3.Buffer()
    .writeHeader()
    .writeCommand(cwc.protocol.ev3.Command.SOUND.PLAY)
...
cwc.protocol.ev3.Commands.prototype.drawClean = function() {
  return new cwc.protocol.ev3.Buffer()
    .writeHeader()
    .writeCommand(cwc.protocol.ev3.Command.UI.DRAW.CLEAN)
    .readSigned();
};
...
cwc.protocol.ev3.Commands.prototype.drawUpdate = function() {
  return new cwc.protocol.ev3.Buffer()
    .writeHeader()
    .writeCommand(cwc.protocol.ev3.Command.UI.DRAW.UPDATE)
    .readSigned();
};
...
cwc.protocol.ev3.Commands.prototype.drawImage = function(file_name,
  ...
  return new cwc.protocol.ev3.Buffer()
    .writeHeader()
    .writeCommand(cwc.protocol.ev3.Command.UI.DRAW.BMPFILE)
 ...
 * @export
 */
cwc.protocol.ev3.Commands.prototype.drawLine = function(x1, y1, x2, y2, color) {
  return new cwc.protocol.ev3.Buffer()
    .writeHeader()
    .writeCommand(cwc.protocol.ev3.Command.UI.DRAW.LINE)
