 ...
 */
goog.provide('cwc.protocol.sphero.v1.CallbackType');
goog.provide('cwc.protocol.sphero.v1.Command');
goog.provide('cwc.protocol.sphero.v1.CommandType');
goog.provide('cwc.protocol.sphero.v1.MessageType');
 ...
 * @enum {number}
 */
cwc.protocol.sphero.v1.CallbackType = {
  NONE: 0x00,
  LOCATION: 0x10,
  RGB: 0x15,
  VERSION: 0x20,
 ...
 */
cwc.protocol.sphero.v1.Command = {
  SYSTEM: {
    PING: [0x00, 0x01],
    VERSION: [0x00, 0x02],
 ...
 */
cwc.protocol.sphero.v1.CommandType = {
  DIRECT: {
    REPLY: 0xFF,
    NOREPLY: 0xFE,
  },
