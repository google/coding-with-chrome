 ...
 */
goog.provide('cwc.protocol.sphero.classic.Handler');
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['boost'] = function(data) {
 ...
 */
cwc.protocol.sphero.classic.Handler.prototype['calibrate'] = function(data) {
  let cmds = [];
  if (!this.calibrate_) {
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['getRGB'] = function() {
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['getLocation'] = function() {
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['getVersion'] = function() {
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['roll'] = function(data) {
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['rollStop'] = function() {
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['setBackLed'] = function(
    data = {}) {
 ...
 * @return {!Array<ArrayBuffer>|ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['setCalibration'] = function() {
  this.calibrate_ = false;
  return [
    this['setBackLed'](),
    this['setHeading'](),
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['setCollisionDetection'] =
    function() {
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['setHeading'] = function(
    data = {}) {
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['setMotionTimeout'] = function(
    data) {
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['setRGB'] = function(data = {}) {
 ...
 * @return {!ArrayBuffer}
 */
cwc.protocol.sphero.classic.Handler.prototype['sleep'] = function(data = {}) {
 ...
 */
cwc.protocol.sphero.classic.Handler.prototype['stop'] = function() {
  return [
