 ...
 */
goog.provide('cwc.protocol.mbot.Commands');
 ...
 * @final
 */
cwc.protocol.mbot.Commands = function() {
  /** @private {Object} */
  this.cache_ = {};
};
 ...
 * @export
 */
cwc.protocol.mbot.Commands.prototype.setRGBLED = function(red, green, blue,
    opt_index) {
 ...
 * @export
 */
cwc.protocol.mbot.Commands.prototype.playTone = function(frequency, duration) {
  var buffer = new cwc.protocol.mbot.Buffer();
  buffer.writeIndex(cwc.protocol.mbot.Command.INDEX_WITHOUT_RESPONSE);
  buffer.writeType(cwc.protocol.mbot.CommandType.WRITE);
 ...
 * @export
 */
cwc.protocol.mbot.Commands.prototype.setMotorPower = function(power, opt_port) {
  var buffer = new cwc.protocol.mbot.Buffer();
  buffer.writeIndex(cwc.protocol.mbot.Command.INDEX_WITHOUT_RESPONSE);
  buffer.writeType(cwc.protocol.mbot.CommandType.WRITE);
