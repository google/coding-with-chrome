 ...
 */
goog.provide('cwc.mode.sphero.sprkPlus.Calibration');

goog.require('cwc.soy.mode.sphero.sprkPlus.Calibration');
 ...
 */
cwc.mode.sphero.sprkPlus.Calibration = function(helper, connection) {
  /** @type {string} */
  this.name = 'Sphero 2.0 Calibration';

  /** @type {string} */
  this.prefix = helper.getPrefix('sphero-sprk-plus-calibration');
  ...
  /** @type {!cwc.protocol.sphero.sprkPlus.Api} */
 ...
 * @export
 */
cwc.mode.sphero.sprkPlus.Calibration.prototype.decorate = function(node) {
  this.node = node;

  goog.soy.renderElement(
    this.node,
    cwc.soy.mode.sphero.sprkPlus.Calibration.template, {
      prefix: this.prefix,
    }
  );
 ...
 * @private
 */
cwc.mode.sphero.sprkPlus.Calibration.prototype.addEventHandler_ = function() {
  this.events_.listen(
 ...
 * @private
 */
cwc.mode.sphero.sprkPlus.Calibration.prototype.addKeyHandler_ = function() {
 ...
 * @private
 */
cwc.mode.sphero.sprkPlus.Calibration.prototype.handleKeyboardShortcut_ =
    function(event) {
