/**
 * @fileoverview Control pane for the Sphero SPRK+ modification.
 *
 ...
 */
goog.provide('cwc.mode.sphero.sprkPlus.Control');

goog.require('cwc.soy.mode.sphero.sprkPlus.Control');
 ...
 * @export
 */
cwc.mode.sphero.sprkPlus.Control.prototype.decorate = function(node) {
  this.node = node;

  goog.soy.renderElement(
    this.node,
    cwc.soy.mode.sphero.sprkPlus.Control.template, {
      prefix: this.prefix,
    }
  );
 ...
 * @private
 */
cwc.mode.sphero.sprkPlus.Control.prototype.addGamepadHandler_ = function() {
 ...
 * @private
 */
cwc.mode.sphero.sprkPlus.Control.prototype.addKeyHandler_ = function() {
 ...
 * @private
 */
cwc.mode.sphero.sprkPlus.Control.prototype.handleKeyboardShortcut_ = function(
    event) {
