...
goog.require('cwc.soy.mode.makeblock.mbotRanger.blockly.Blocks');
...
cwc.mode.makeblock.mbotRanger.blockly.Editor.prototype.decorate = function() {
  ...
  goog.soy.renderElement(this.nodeBlocklyToolbox,
    cwc.soy.mode.makeblock.mbotRanger.blockly.Blocks.toolbox);
 ...
 * Code change handler.
 */
cwc.mode.makeblock.mbotRanger.blockly.Editor.prototype.changeHandler = function(
) {
