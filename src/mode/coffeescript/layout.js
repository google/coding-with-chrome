/**
 * @fileoverview Layout for the Coffeescript modification.
 *
 ...
 */
goog.provide('cwc.mode.coffeescript.Layout');

goog.require('cwc.soy.mode.Coffeescript');
 ...
 */
cwc.mode.coffeescript.Layout = function(helper) {
