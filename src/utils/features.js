...
cwc.utils.Features.prototype.detectChromeFeatures = function() {
  ...
  this.setChromeFeature('app', typeof chrome.app.window);
  ...
  // App features.
  this.setChromeFeature('mdns', false);
  this.setChromeFeature('webview', false);
...
cwc.utils.Features.prototype.detectJavaScripts = function() {
  ...
  this.setJavaScriptFeature('clEditor', typeof window['clEditor']);
};
