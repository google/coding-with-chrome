 ...
 */
goog.provide('cwc.renderer.external.lego.EV3');
 ...
 * @final
 */
cwc.renderer.external.lego.EV3 = function(helper) {
 ...
 * @return {!Promise}
 */
cwc.renderer.external.lego.EV3.prototype.init = function() {
 ...
 * @export
 */
cwc.renderer.external.lego.EV3.prototype.render = function(
    editorContent,
    libraryFiles,
    rendererHelper,
    environ = {}) {
