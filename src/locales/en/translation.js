...
cwc.locales.en.Translation = {
  ...
  'Move the Sphero in a direction for the given seconds': 'Move the Sphero in a direction for the given seconds',
  'Move the Sphero in a direction': 'Move the Sphero in a direction',
  'Move the pen up or down by a certain number of steps.': 'Move the pen up or down by a certain number of steps.',
  'Move the robot backward for a specified number of steps.': 'Move the robot backward for a specified number of steps.',
  'Move the robot forward for a specified number of steps.': 'Move the robot forward for a specified number of steps.',
  'Move the robot in a direction for a specified distance.': 'Move the robot in a direction for a specified distance.',
  'Move the servo by a certain number of steps.': 'Move the servo by a certain number of steps.',
  'Music': 'Music',
  'My files': 'My files',
  ...
  'Serial is disabled!': 'Serial is disabled!',
  'Set the power of the motors to a certain power.This setting remains until the program is complete or is updated.': 'Set the power of the motors to a certain power.This setting remains until the program is complete or is updated.',
  'Sets the EV3 robot model.': 'Sets the EV3 robot model.',
  'Sets the colors sensor mode.': 'Sets the colors sensor mode.',
  ...
  'Turn the robot left by amount of the specified angle.': 'Turn the robot left by amount of the specified angle.',
  'Turn the robot right by amount of the specified angle.': 'Turn the robot right by amount of the specified angle.',
  ...
  'pulse': 'pulse',
  'red': 'red',
  'reflected light of red light': 'reflected light of red light',
