...
Blockly.Blocks['ev3_touch_sensor_value'] = {
  init: function() {
    ...
    this.setColour(260);
    this.appendDummyInput()
        .appendField('Touch sensor value');
    this.setOutput(true, 'Number');
...
Blockly.Blocks['ev3_color_sensor_change'] = {
  init: function() {
    ...
    this.setColour(260);
    this.appendDummyInput()
        .appendField('Color Sensor Change')
...
Blockly.Blocks['ev3_touch_sensor_change'] = {
  init: function() {
    ...
    this.setColour(260);
    this.appendDummyInput()
        .appendField('Touch Sensor Change')
        .appendField(new Blockly.FieldVariable('value'), 'VALUE');
    this.appendStatementInput('CODE')
        .setAlign(Blockly.ALIGN_CENTRE);
    this.setPreviousStatement(true);
...
Blockly.Blocks['ev3_touch_sensor_change'] = {
  init: function() {
    ...
    this.setColour(260);
    this.appendDummyInput()
        .appendField('On Touch Sensor Change')
        .appendField(new Blockly.FieldVariable('value'), 'VALUE');
    this.appendStatementInput('CODE')
        .setAlign(Blockly.ALIGN_CENTRE);
    this.setPreviousStatement(true);
